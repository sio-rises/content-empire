        ...
        <div className="flex min-h-screen flex-col">
          ...
          <footer className="border-t border-gray-200 bg-white py-6 text-center text-xs text-gray-400">
            ...
            <div className="border-t border-gray-100 mt-4 pt-3 text-center text-[10px] text-gray-300">
              ...
              <a href="https://arch-linux-guide.pages.dev" className="hover:underline">Arch Linux日本語ガイド</a>  <a href="https://ai-agent-guide.pages.dev" className="hover:underline">AIエージェント活用</a>  <a href="https://linux-security.pages.dev" className="hover:underline">Linuxセキュリティ</a>  <a href="https://vps-server-guide.pages.dev" className="hover:underline">VPSサーバー構築</a>
            </div>
          </footer>
        </div>
      </body>
